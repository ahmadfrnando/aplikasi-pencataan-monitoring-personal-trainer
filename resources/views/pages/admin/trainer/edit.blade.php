...
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Ubah Data Trainer</h5>
                <div class="card">
                    <div class="card-body">
                        <form id="formSubmit">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') ?? $trainer->name }}" id="name" class="form-control @error('name') is-invalid @enderror" id="name" oninput="capitalizeWords(this)">
                                    @error('name')
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') ?? $trainer->email }}" id="email" class="form-control @error('email') is-invalid @enderror" id="email" oninput="capitalizeWords(this)">
                                    @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="password" name="password" value="{{ old('password') ?? $trainer->password }}" id="password" class="form-control @error('password') is-invalid @enderror" id="password" oninput="capitalizeWords(this)">
                                    @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
<script type='text/javascript'>
    $(function() {
        ...
        let actionUrl = "{{ route('admin.trainer.update', $trainer->id) }}";
