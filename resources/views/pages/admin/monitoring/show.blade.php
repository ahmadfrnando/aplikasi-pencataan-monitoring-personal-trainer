...
@section('content')
<div class="row">
    <a href="{{ route('admin.monitoring.index') }}" class="text-secondary-emphasis mb-4 d-inline"><i class="ti ti-arrow-left"></i> Kembali</a>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="mb-2 row">
    ...
    @include('pages.admin.monitoring.chart.stats-overview')
    @include('pages.admin.monitoring.chart.kebugaran-tubuh-chart')
    @include('pages.admin.monitoring.chart.riwayat-data-pengukuran')
...
<script type='text/javascript'>
    $(function() {
        var route = "{{ route('admin.monitoring.riwayat-data-pengukuran', $klien->id) }}";
