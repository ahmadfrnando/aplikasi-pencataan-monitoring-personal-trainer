                    ...
                    <table class="table data-table">
                        <thead class="text-sm">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary font-weight-bolder opacity-7">Nama Trainer
                                </th>
                                <th class="text-uppercase text-secondary font-weight-bolder opacity-7">Nama Klien
                                </th>
